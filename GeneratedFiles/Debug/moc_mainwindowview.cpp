...
const QMetaObjectExtraData MainWindowView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MainWindowView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_MainWindowView,
      qt_meta_data_MainWindowView, &staticMetaObjectExtraData }
};
